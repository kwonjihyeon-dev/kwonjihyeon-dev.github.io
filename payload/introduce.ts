...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '사용자가 겪는 문제를 좇다 보니, 팀 내부의 비효율도 개선 대상으로 삼았습니다. 팝업을 바꿀 때마다 필요하던 배포를 서버 설정만으로 대응할 수 있도록 대체했고, 디자인 토큰을 자동화해 여러 프로젝트가 동일한 기준을 공유하도록 만들었습니다. 변경이 잦은 서비스 핵심 기능에는 Playwright · Vitest로 QA 자동화를 구축해, 오류와 CS 대응 부담을 줄였습니다.',
